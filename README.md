...
I'm a Fractional Principal Engineer at [Voice Swap](https://www.voice-swap.ai/) and a Fractional Senior Engineering Manager for Product Services at [Learning Pool](https://github.com/HT2-Labs)

At Learning Pool, I'm primarily working across three great engineering teams.
...
Outside these roles, I'm currently developing and maintaining the following projects.
...
Along my journey from a Trainee Software Engineer to a Lead Software Engineer and now in my current roles, I've had the opportunity to work with a lot of great folks, a lot of tech and on some great projects - most notably during my time working on [Learning Locker](http://github.com/LearningLocker/learninglocker) and associated projects like [the Moodle xAPI Logstore plugin](https://github.com/xAPI-vle/moodle-logstore_xapi).
